...
# if test $? = 1
# then
#     echo "testID: harsh_r0_test.bin, Instr: N/A, Status: PASS, Author: $USER, Notes: r0 remains unmodified as it should, " | paste -sd ' ' >> ./test/output/"$dt"
# elif test $? = 0
# then
#     echo "testID: harsh_r0_test.bin, Instr: N/A, Status: FAIL, Author: $USER, Notes: branch did not occur so delay slot instruction was able to modify r0 at least temporarily, " | paste -sd ' ' >> ./test/output/"$dt"
# else
#     echo "testID: harsh_r0_test.bin, Instr: N/A, Status: FAIL, Author: $USER, Notes: No idea why it failed, " | paste -sd ' ' >> ./test/output/"$dt"
# fi
...
# if test $? = 245
# then
#     echo "testID: sw_ov.bin, Instr: SW, Status: PASS, Author: $USER, Notes: catces out of range memory loading, " | paste -sd ' ' >> ./test/output/"$dt"
# else
#     echo "testID: sw_ov.bin, Instr: SW, Status: FAIL, Author: $USER, Notes: doesn't catch trying to load out of range mem, " | paste -sd ' ' >> ./test/output/"$dt"
# fi
