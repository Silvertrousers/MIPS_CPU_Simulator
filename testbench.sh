...
# if test $? = 64
# then
#     echo "testID: sb_o.bin, Instr: SB, Status: PASS, Author: Silvertrousers (Cyrus Goodarzi), Notes: stores right part of word and puts it in the right place in mem, " | paste -sd ' ' >> ./test/output/"$dt"
# elif test $? = 48
# then
#     echo "testID: sb_o.bin, Instr: SB, Status: FAIL, Author: Silvertrousers (Cyrus Goodarzi), Notes: stores wrong part of the word but put it in right place in mem, " | paste -sd ' ' >> ./test/output/"$dt"
# else
#     echo "testID: sb_o.bin, Instr: SB, Status: FAIL, Author: Silvertrousers (Cyrus Goodarzi), Notes: stores wrong part of the word and/or put it in wrong place in mem, " | paste -sd ' ' >> ./test/output/"$dt"
# fi
...
# fi
# OUTPUT=$(sudo ./bin/mips_simulator "test_binaries/sh_hw0.bin")
# if test $? = 34
# then
#     echo "testID: sh_hw0.bin, Instr: SH, Status: PASS, Author: Silvertrousers (Cyrus Goodarzi), Notes: ----, " | paste -sd ' ' >> ./test/output/"$dt"
# else
#     echo "testID: sh_hw0.bin, Instr: SH, Status: FAIL, Author: Silvertrousers (Cyrus Goodarzi), Notes: ------, " | paste -sd ' ' >> ./test/output/"$dt"
# fi
# OUTPUT=$(sudo ./bin/mips_simulator "test_binaries/sh_hw1.bin")
# if test $? = 34
# then
#     echo "testID: sh_hw1.bin, Instr: SH, Status: PASS, Author: Silvertrousers (Cyrus Goodarzi), Notes: ----, " | paste -sd ' ' >> ./test/output/"$dt"
# else
#     echo "testID: sh_hw1.bin, Instr: SH, Status: FAIL, Author: Silvertrousers (Cyrus Goodarzi), Notes: ------, " | paste -sd ' ' >> ./test/output/"$dt"
# fi
